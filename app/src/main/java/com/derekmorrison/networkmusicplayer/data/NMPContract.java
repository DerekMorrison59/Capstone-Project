...
public class NMPContract {
    ...
    public static final class PlaylistEntry implements BaseColumns {
        ...
        public static final int COL_ID = 0;
        public static final int COL_PLAYLIST_NAME = 1;
        public static final int COL_PLAYLIST_ID = 2;
    }
    ...
    public static final class PlaylistItemEntry implements BaseColumns {
        ...
        public static final String COLUMN_PLAYLIST_ITEM_PARENT_ID = "playlist_parent_id";
        public static final String COLUMN_PLAYLIST_ITEM_SONG_ID = "playlist_song_id";
...
*/
        public static final int COL_ID = 0;
        public static final int COL_PLAYLIST_ITEM_PARENT_ID = 1;
